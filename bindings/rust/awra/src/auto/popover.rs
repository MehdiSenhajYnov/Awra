...
glib::wrapper! {
    #[doc(alias = "AwraPopover")]
    pub struct Popover(Object<ffi::AwraPopover, ffi::AwraPopoverClass>) @extends gtk::Popover, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::ShortcutManager;

    match fn {
        type_ => || ffi::awra_popover_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraPopover")]
    pub struct Popover(Object<ffi::AwraPopover, ffi::AwraPopoverClass>) @extends gtk::Popover, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::ShortcutManager;
...
impl Popover {
    #[doc(alias = "awra_popover_new")]
    pub fn new() -> Popover {
        assert_initialized_main_thread!();
        unsafe { gtk::Widget::from_glib_none(ffi::awra_popover_new()).unsafe_cast() }
    }
    ...
    #[doc(alias = "awra_popover_get_child")]
    #[doc(alias = "get_child")]
    pub fn child(&self) -> Option<gtk::Widget> {
        unsafe { from_glib_none(ffi::awra_popover_get_child(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_popover_get_menu_model")]
    #[doc(alias = "get_menu_model")]
    #[doc(alias = "menu-model")]
    pub fn menu_model(&self) -> Option<gio::MenuModel> {
        unsafe { from_glib_none(ffi::awra_popover_get_menu_model(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_popover_get_surface")]
    #[doc(alias = "get_surface")]
    pub fn surface(&self) -> Surface {
        unsafe { from_glib_none(ffi::awra_popover_get_surface(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_popover_set_child")]
    #[doc(alias = "child")]
    pub fn set_child(&self, child: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::awra_popover_set_child(
                self.to_glib_none().0,
    ...
    #[doc(alias = "awra_popover_set_menu_model")]
    #[doc(alias = "menu-model")]
    pub fn set_menu_model(&self, model: Option<&impl IsA<gio::MenuModel>>) {
        unsafe {
            ffi::awra_popover_set_menu_model(
                self.to_glib_none().0,
    ...
    pub fn connect_menu_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_menu_model_trampoline<F: Fn(&Popover) + 'static>(
            this: *mut ffi::AwraPopover,
    ...
    pub fn connect_surface_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_surface_trampoline<F: Fn(&Popover) + 'static>(
            this: *mut ffi::AwraPopover,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
...
impl PopoverBuilder {
    ...
    //pub fn pointing_to(self, pointing_to: /*Ignored*/&gdk::Rectangle) -> Self {
    //    Self { builder: self.builder.property("pointing-to", pointing_to), }
    //}

    //pub fn position(self, position: /*Ignored*/gtk::PositionType) -> Self {
