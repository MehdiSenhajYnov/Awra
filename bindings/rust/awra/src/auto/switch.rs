...
glib::wrapper! {
    #[doc(alias = "AwraSwitch")]
    pub struct Switch(Object<ffi::AwraSwitch, ffi::AwraSwitchClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::awra_switch_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraSwitch")]
    pub struct Switch(Object<ffi::AwraSwitch, ffi::AwraSwitchClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget;
...
impl Switch {
    #[doc(alias = "awra_switch_new")]
    pub fn new() -> Switch {
        assert_initialized_main_thread!();
        unsafe { gtk::Widget::from_glib_none(ffi::awra_switch_new()).unsafe_cast() }
    }
    ...
    #[doc(alias = "awra_switch_get_active")]
    #[doc(alias = "get_active")]
    #[doc(alias = "active")]
    pub fn is_active(&self) -> bool {
        unsafe { from_glib(ffi::awra_switch_get_active(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_switch_get_delegate")]
    #[doc(alias = "get_delegate")]
    pub fn delegate(&self) -> gtk::Switch {
        unsafe { from_glib_none(ffi::awra_switch_get_delegate(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_switch_set_active")]
    #[doc(alias = "active")]
    pub fn set_active(&self, active: bool) {
        unsafe {
            ffi::awra_switch_set_active(self.to_glib_none().0, active.into_glib());
        }
    }
