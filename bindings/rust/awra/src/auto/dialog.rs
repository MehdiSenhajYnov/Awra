...
glib::wrapper! {
    #[doc(alias = "AwraDialog")]
    pub struct Dialog(Object<ffi::AwraDialog, ffi::AwraDialogClass>) @extends Window, gtk::ApplicationWindow, gtk::Window, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager, gio::ActionGroup;

    match fn {
        type_ => || ffi::awra_dialog_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraDialog")]
    pub struct Dialog(Object<ffi::AwraDialog, ffi::AwraDialogClass>) @extends Window, gtk::ApplicationWindow, gtk::Window, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager, gio::ActionGroup;
...
impl Dialog {
    #[doc(alias = "awra_dialog_new")]
    pub fn new(parent: Option<&impl IsA<gtk::Window>>) -> Dialog {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_full(ffi::awra_dialog_new(
