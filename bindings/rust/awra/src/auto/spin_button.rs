...
glib::wrapper! {
    #[doc(alias = "AwraSpinButton")]
    pub struct SpinButton(Object<ffi::AwraSpinButton, ffi::AwraSpinButtonClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::awra_spin_button_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraSpinButton")]
    pub struct SpinButton(Object<ffi::AwraSpinButton, ffi::AwraSpinButtonClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget;
...
impl SpinButton {
    #[doc(alias = "awra_spin_button_new_with_range")]
    #[doc(alias = "new_with_range")]
    pub fn with_range(minimum: f64, maximum: f64, step: f64) -> SpinButton {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_none(ffi::awra_spin_button_new_with_range(
    ...
    #[doc(alias = "awra_spin_button_get_delegate")]
    #[doc(alias = "get_delegate")]
    pub fn delegate(&self) -> gtk::SpinButton {
        unsafe { from_glib_none(ffi::awra_spin_button_get_delegate(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_spin_button_get_value")]
    #[doc(alias = "get_value")]
    pub fn value(&self) -> f64 {
        unsafe { ffi::awra_spin_button_get_value(self.to_glib_none().0) }
    }

    #[doc(alias = "awra_spin_button_set_value")]
    #[doc(alias = "value")]
    pub fn set_value(&self, value: f64) {
        unsafe {
            ffi::awra_spin_button_set_value(self.to_glib_none().0, value);
        }
    }
