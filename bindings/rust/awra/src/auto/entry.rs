...
glib::wrapper! {
    #[doc(alias = "AwraEntry")]
    pub struct Entry(Object<ffi::AwraEntry, ffi::AwraEntryClass>) @extends gtk::Entry, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::CellEditable, gtk::Editable;

    match fn {
        type_ => || ffi::awra_entry_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraEntry")]
    pub struct Entry(Object<ffi::AwraEntry, ffi::AwraEntryClass>) @extends gtk::Entry, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::CellEditable, gtk::Editable;
...
impl Entry {
    #[doc(alias = "awra_entry_new")]
    pub fn new() -> Entry {
        assert_initialized_main_thread!();
        unsafe { gtk::Widget::from_glib_none(ffi::awra_entry_new()).unsafe_cast() }
    }
...
impl EntryBuilder {
    ...
    //    #[cfg_attr(feature = "gtk_v4_10", deprecated = "Since 4.10")]
    ...
    //pub fn primary_icon_gicon(self, primary_icon_gicon: &impl IsA</*Ignored*/gio::Icon>) -> Self {
    ...
    //pub fn secondary_icon_gicon(self, secondary_icon_gicon: &impl IsA</*Ignored*/gio::Icon>) -> Self {
    ...
    pub fn input_interceptor(self, input_interceptor: &impl IsA<gtk::Widget>) -> Self {
        Self {
            builder: self
                .builder
