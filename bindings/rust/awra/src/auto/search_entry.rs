...
glib::wrapper! {
    #[doc(alias = "AwraSearchEntry")]
    pub struct SearchEntry(Object<ffi::AwraSearchEntry, ffi::AwraSearchEntryClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::awra_search_entry_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraSearchEntry")]
    pub struct SearchEntry(Object<ffi::AwraSearchEntry, ffi::AwraSearchEntryClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget;
...
impl SearchEntry {
    #[doc(alias = "awra_search_entry_new")]
    pub fn new() -> SearchEntry {
        assert_initialized_main_thread!();
        unsafe { gtk::Widget::from_glib_none(ffi::awra_search_entry_new()).unsafe_cast() }
    }
    ...
    #[doc(alias = "awra_search_entry_get_delegate")]
    #[doc(alias = "get_delegate")]
    pub fn delegate(&self) -> gtk::SearchEntry {
        unsafe { from_glib_none(ffi::awra_search_entry_get_delegate(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_search_entry_get_placeholder_text")]
    #[doc(alias = "get_placeholder_text")]
    #[doc(alias = "placeholder-text")]
    pub fn placeholder_text(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::awra_search_entry_get_placeholder_text(
                self.to_glib_none().0,
            ))
        }
    }

    #[doc(alias = "awra_search_entry_get_text")]
    #[doc(alias = "get_text")]
    pub fn text(&self) -> glib::GString {
        unsafe { from_glib_none(ffi::awra_search_entry_get_text(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_search_entry_set_placeholder_text")]
    #[doc(alias = "placeholder-text")]
    pub fn set_placeholder_text(&self, text: &str) {
        unsafe {
            ffi::awra_search_entry_set_placeholder_text(
                self.to_glib_none().0,
                text.to_glib_none().0,
            );
        }
    ...
    #[doc(alias = "awra_search_entry_set_text")]
    #[doc(alias = "text")]
    pub fn set_text(&self, text: &str) {
        unsafe {
            ffi::awra_search_entry_set_text(self.to_glib_none().0, text.to_glib_none().0);
        }
    }
    ...
    pub fn connect_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_trampoline<F: Fn(&SearchEntry) + 'static>(
            this: *mut ffi::AwraSearchEntry,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
