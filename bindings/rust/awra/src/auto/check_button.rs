...
glib::wrapper! {
    #[doc(alias = "AwraCheckButton")]
    pub struct CheckButton(Object<ffi::AwraCheckButton, ffi::AwraCheckButtonClass>) @extends gtk::CheckButton, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;

    match fn {
        type_ => || ffi::awra_check_button_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraCheckButton")]
    pub struct CheckButton(Object<ffi::AwraCheckButton, ffi::AwraCheckButtonClass>) @extends gtk::CheckButton, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
impl CheckButton {
    #[doc(alias = "awra_check_button_new")]
    pub fn new() -> CheckButton {
        assert_initialized_main_thread!();
        unsafe { gtk::Widget::from_glib_none(ffi::awra_check_button_new()).unsafe_cast() }
    }

    #[doc(alias = "awra_check_button_new_with_label")]
    #[doc(alias = "new_with_label")]
    pub fn with_label(label: &str) -> CheckButton {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_none(ffi::awra_check_button_new_with_label(
    ...
    #[doc(alias = "awra_check_button_set_group")]
    pub fn set_group(&self, group: &CheckButton) {
        unsafe {
            ffi::awra_check_button_set_group(self.to_glib_none().0, group.to_glib_none().0);
        }
    }
}
...
impl CheckButtonBuilder {
    ...
    #[cfg(feature = "gtk_v4_8")]
    #[cfg_attr(docsrs, doc(cfg(feature = "gtk_v4_8")))]
    ...
    pub fn group(self, group: &impl IsA<gtk::CheckButton>) -> Self {
        Self {
