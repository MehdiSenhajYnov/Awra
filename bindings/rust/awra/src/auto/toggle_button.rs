...
use crate::{ffi, ButtonAppearance};
use glib::{
    prelude::*,
...
glib::wrapper! {
    #[doc(alias = "AwraToggleButton")]
    pub struct ToggleButton(Object<ffi::AwraToggleButton, ffi::AwraToggleButtonClass>) @extends gtk::ToggleButton, gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;

    match fn {
        type_ => || ffi::awra_toggle_button_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraToggleButton")]
    pub struct ToggleButton(Object<ffi::AwraToggleButton, ffi::AwraToggleButtonClass>) @extends gtk::ToggleButton, gtk::Button, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Actionable;
...
impl ToggleButton {
    #[doc(alias = "awra_toggle_button_new")]
    pub fn new() -> ToggleButton {
        assert_initialized_main_thread!();
        unsafe { gtk::Widget::from_glib_none(ffi::awra_toggle_button_new()).unsafe_cast() }
    }

    #[doc(alias = "awra_toggle_button_new_with_label")]
    #[doc(alias = "new_with_label")]
    pub fn with_label(label: &str) -> ToggleButton {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_none(ffi::awra_toggle_button_new_with_label(
    ...
    #[doc(alias = "awra_toggle_button_get_appearance")]
    #[doc(alias = "get_appearance")]
    pub fn appearance(&self) -> ButtonAppearance {
        unsafe {
            from_glib(ffi::awra_toggle_button_get_appearance(
                self.to_glib_none().0,
            ))
        }
    }

    #[doc(alias = "awra_toggle_button_set_appearance")]
    #[doc(alias = "appearance")]
    pub fn set_appearance(&self, appearance: ButtonAppearance) {
        unsafe {
            ffi::awra_toggle_button_set_appearance(self.to_glib_none().0, appearance.into_glib());
        }
    }

    #[doc(alias = "appearance")]
    pub fn connect_appearance_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_appearance_trampoline<F: Fn(&ToggleButton) + 'static>(
            this: *mut ffi::AwraToggleButton,
