...
glib::wrapper! {
    #[doc(alias = "AwraWindow")]
    pub struct Window(Object<ffi::AwraWindow, ffi::AwraWindowClass>) @extends gtk::ApplicationWindow, gtk::Window, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager, gio::ActionGroup, gio::ActionMap;

    match fn {
        type_ => || ffi::awra_window_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraWindow")]
    pub struct Window(Object<ffi::AwraWindow, ffi::AwraWindowClass>) @extends gtk::ApplicationWindow, gtk::Window, gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget, gtk::Native, gtk::Root, gtk::ShortcutManager, gio::ActionGroup, gio::ActionMap;
...
impl Window {
    ...
    #[doc(alias = "awra_window_new")]
    pub fn new(application: &impl IsA<gtk::Application>) -> Window {
        assert_initialized_main_thread!();
        unsafe {
            gtk::Widget::from_glib_none(ffi::awra_window_new(application.as_ref().to_glib_none().0))
                .unsafe_cast()
        }
    }
...
pub trait WindowExt: IsA<Window> + 'static {
    #[doc(alias = "awra_window_get_active")]
    #[doc(alias = "get_active")]
    fn is_active(&self) -> bool {
        unsafe { from_glib(ffi::awra_window_get_active(self.as_ref().to_glib_none().0)) }
    }

    #[doc(alias = "awra_window_get_chrome")]
    #[doc(alias = "get_chrome")]
    fn chrome(&self) -> gtk::Widget {
        unsafe { from_glib_none(ffi::awra_window_get_chrome(self.as_ref().to_glib_none().0)) }
    }

    #[doc(alias = "awra_window_get_content")]
    #[doc(alias = "get_content")]
    fn content(&self) -> Option<gtk::Widget> {
        unsafe { from_glib_none(ffi::awra_window_get_content(self.as_ref().to_glib_none().0)) }
    }

    #[doc(alias = "awra_window_get_root_surface")]
    #[doc(alias = "get_root_surface")]
    #[doc(alias = "root-surface")]
    fn root_surface(&self) -> Surface {
        unsafe {
            from_glib_none(ffi::awra_window_get_root_surface(
                self.as_ref().to_glib_none().0,
            ))
        }
    }

    #[doc(alias = "awra_window_set_chrome")]
    #[doc(alias = "chrome")]
    fn set_chrome(&self, chrome: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::awra_window_set_chrome(
                self.as_ref().to_glib_none().0,
                chrome.map(|p| p.as_ref()).to_glib_none().0,
            );
        }
    }

    #[doc(alias = "awra_window_set_content")]
    #[doc(alias = "content")]
    fn set_content(&self, content: Option<&impl IsA<gtk::Widget>>) {
        unsafe {
            ffi::awra_window_set_content(
                self.as_ref().to_glib_none().0,
    ...
    #[doc(alias = "chrome")]
    fn connect_chrome_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_chrome_trampoline<P: IsA<Window>, F: Fn(&P) + 'static>(
            this: *mut ffi::AwraWindow,
        ...
        unsafe {
            ...
            connect_raw(
                ...
                c"notify::chrome".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_chrome_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    #[doc(alias = "root-surface")]
    fn connect_root_surface_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_root_surface_trampoline<P: IsA<Window>, F: Fn(&P) + 'static>(
            this: *mut ffi::AwraWindow,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::root-surface".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_root_surface_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
