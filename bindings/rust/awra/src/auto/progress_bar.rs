...
glib::wrapper! {
    #[doc(alias = "AwraProgressBar")]
    pub struct ProgressBar(Object<ffi::AwraProgressBar, ffi::AwraProgressBarClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;

    match fn {
        type_ => || ffi::awra_progress_bar_get_type(),
    }
}
...
glib::wrapper! {
    #[doc(alias = "AwraProgressBar")]
    pub struct ProgressBar(Object<ffi::AwraProgressBar, ffi::AwraProgressBarClass>) @extends gtk::Widget, gobject::InitiallyUnowned, @implements gtk::Buildable, gtk::ConstraintTarget;
...
impl ProgressBar {
    #[doc(alias = "awra_progress_bar_new")]
    pub fn new() -> ProgressBar {
        assert_initialized_main_thread!();
        unsafe { gtk::Widget::from_glib_none(ffi::awra_progress_bar_new()).unsafe_cast() }
    }
    ...
    #[doc(alias = "awra_progress_bar_get_delegate")]
    #[doc(alias = "get_delegate")]
    pub fn delegate(&self) -> gtk::ProgressBar {
        unsafe { from_glib_none(ffi::awra_progress_bar_get_delegate(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_progress_bar_get_fraction")]
    #[doc(alias = "get_fraction")]
    pub fn fraction(&self) -> f64 {
        unsafe { ffi::awra_progress_bar_get_fraction(self.to_glib_none().0) }
    }

    #[doc(alias = "awra_progress_bar_get_show_text")]
    #[doc(alias = "get_show_text")]
    #[doc(alias = "show-text")]
    pub fn shows_text(&self) -> bool {
        unsafe { from_glib(ffi::awra_progress_bar_get_show_text(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_progress_bar_get_text")]
    #[doc(alias = "get_text")]
    pub fn text(&self) -> glib::GString {
        unsafe { from_glib_none(ffi::awra_progress_bar_get_text(self.to_glib_none().0)) }
    }

    #[doc(alias = "awra_progress_bar_set_fraction")]
    #[doc(alias = "fraction")]
    pub fn set_fraction(&self, fraction: f64) {
        unsafe {
            ffi::awra_progress_bar_set_fraction(self.to_glib_none().0, fraction);
        }
    }

    #[doc(alias = "awra_progress_bar_set_show_text")]
    #[doc(alias = "show-text")]
    pub fn set_show_text(&self, show_text: bool) {
        unsafe {
            ffi::awra_progress_bar_set_show_text(self.to_glib_none().0, show_text.into_glib());
        }
    }

    #[doc(alias = "awra_progress_bar_set_text")]
    #[doc(alias = "text")]
    pub fn set_text(&self, text: &str) {
        unsafe {
            ffi::awra_progress_bar_set_text(self.to_glib_none().0, text.to_glib_none().0);
        }
    }
